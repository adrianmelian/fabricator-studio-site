...
export const INSTALLER_NAME = 'Armature-2.1.9-Setup.exe';
...
export const ARMATURE = {
  ...
  // The 2026-08-13 build, Armature 2.1.9. Verified before publish: the disk hash
  // matches Adrian's relayed checksum, the .sha256 sidecar and latest.yml's sha512 and size
  // (137344721) all agree, and the publish script re-verified the served bytes from the
  ...
  sha256: '16aa5558d1f6647143bb4d607985a6f5334ea67a46a6581379c59ea0ce17433a',
