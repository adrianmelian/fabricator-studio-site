...
export const INSTALLER_NAME = 'Armature-2.1.6-Setup.exe';
...
export const ARMATURE = {
  ...
  // The 2026-08-08 build, Armature 2.1.6. Verified before publish: the disk hash matches
  // Adrian's relayed checksum, the .sha256 sidecar and latest.yml's sha512 and size
  // (137356284) all agree, and the publish script re-verified the served bytes from the
  ...
  sha256: 'bf7216189029bfab8134f3547466b854c4e039824b1590c8120a6e568dab30a4',
