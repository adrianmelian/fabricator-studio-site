...
export const INSTALLER_NAME = 'Armature-2.1.7-Setup.exe';
...
export const ARMATURE = {
  ...
  // The 2026-08-12 build, Armature 2.1.7. Verified before publish: the disk hash matches
  // Adrian's relayed checksum, the .sha256 sidecar and latest.yml's sha512 and size
  // (137357871) all agree, and the publish script re-verified the served bytes from the
  ...
  sha256: '3e05d31c47c8f5a9ddc93b42d65e7200e8e3befa0466ec3a35cc9100a2c82d15',
