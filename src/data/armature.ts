...
export const INSTALLER_NAME = 'Armature-2.1.8-Setup.exe';
...
export const ARMATURE = {
  ...
  // The 2026-08-12 late build, Armature 2.1.8. Verified before publish: the disk hash
  // matches Adrian's relayed checksum, the .sha256 sidecar and latest.yml's sha512 and size
  // (137359166) all agree, and the publish script re-verified the served bytes from the
  // public URL. Prior release hashes retire with their releases; their installers stay on
  // the feed under versioned filenames, which is what keeps older auto-updaters working.
  //
  // Empty renders a "published at release" placeholder instead of a wrong hash.
  sha256: '1e169d3ff164c73fd3d58e3b50e9c3cd28ca4698bf3e6472fc7fa1f954388da4',
