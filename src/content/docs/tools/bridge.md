...
## Good to know
- Quick panels open on hover; full tools (Renamer, Export, Curve-O-Matic, Pose/Anim Studios, Fabricator) open on click only, so they never pop up uninvited.
