...
const EXCLUDE = new Set([
  ...
  'tools/renamer',              // removed from the docs (Adrian 2026-07-17)
  'tools/scene-cleanup',        // removed from the docs (Adrian 2026-07-17)
  ...
  'tools/joint-aimer',
  'tools/exporter', 'tools/project-setup', 'tools/ctrl-editor', 'tools/skeleton-io',
  'tools/fabricator', 'tools/skin-io', 'tools/bridge',
